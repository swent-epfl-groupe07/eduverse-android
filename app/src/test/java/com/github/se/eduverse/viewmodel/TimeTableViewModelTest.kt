...
class TimeTableViewModelTest {
    ...
    private val scheduled1 = Scheduled(
        "id1",
        ScheduledType.TASK,
    ...
    private val scheduled2 = Scheduled(
        "id2",
        ScheduledType.EVENT,
    ...
    private val scheduled3 = Scheduled(
        "id3",
        ScheduledType.EVENT,
        Calendar.getInstance().apply {
            timeInMillis = 12
    ...
    fun setUp() {
        ...
        `when`(timeTableRepository.getScheduled(any(), any(), any(), any())).then {
            initialWeek = Calendar.getInstance().apply {
                timeInMillis = it.getArgument<Calendar>(0).timeInMillis
            }
        ...
        weekWithScheduled[(Calendar.THURSDAY - Calendar.getInstance().get(Calendar.DAY_OF_WEEK) + 7) % 7] =
    ...
    fun getDateAtDayTest() {
        ...
        val cal = Calendar.getInstance().apply { time = Date(124, 10, 7) }

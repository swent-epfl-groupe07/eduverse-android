        ...
        Column(
            ...
            Box(
                ...
                CircularProgressIndicator(
                    ...
                    progress = timerState.remainingSeconds.toFloat() / when(timerState.currentTimerType) {
                ...
                Text(
                    text = "${timerState.remainingSeconds / 60}:${String.format("%02d", timerState.remainingSeconds % 60)}",
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        if (timerState.isPaused) timerViewModel.startTimer() else timerViewModel.stopTimer()
                    },
